...
HD_PWD='/auto/fsi/nrbenn14/ecen-323/lab01/proj_buttoncount/ButtonCount/ButtonCount.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ButtonCount.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ButtonCount.tcl
