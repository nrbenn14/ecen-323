...
HD_PWD='/auto/fsi/nrbenn14/ecen-323/lab01/proj_buttoncount/ButtonCount/ButtonCount.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ButtonCount.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ButtonCount.tcl -notrace
