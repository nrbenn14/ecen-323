...
set rc [catch {
  ...
  open_checkpoint ButtonCount_routed.dcp
  ...
  catch { write_mem_info -force ButtonCount.mmi }
  write_bitstream -force ButtonCount.bit 
  catch {write_debug_probes -quiet -force ButtonCount}
  catch {file copy -force ButtonCount.ltx debug_nets.ltx}
