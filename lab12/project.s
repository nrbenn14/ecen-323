...
# Date: 19 April 2023
#
# Description: Displays two characters as part of the game. By using
#               the directional buttons, the player can move the
#               character around. A timer is displayed on the seven-
#               segment display to see how long it takes the player 
#               to get to the other character.
#
# Functions:
# - process buttons
# - restart
